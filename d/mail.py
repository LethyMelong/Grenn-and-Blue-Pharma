...
@app.route('/')
def home():
    return render_template('p.html')  # Assurez-vous que votre fichier HTML est nommé index.html
...
def send_message():
    ...
    msg['From'] = email
    msg['To'] = 'lethyciamelong@gmail.com'  # Remplacez par l'adresse email de votre entreprise
